...
export function DocumentModal({ isOpen, onClose, onSave, editingDocument }) {
    ...
    const modalContent = (
        React.createElement('div', { className: "fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4 transition-opacity duration-300", onClick: onClose },
            React.createElement('div', { className: "bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-3xl w-full mx-4 max-h-[90vh] overflow-y-auto transform transition-all duration-300 scale-95",
                ...
                React.createElement('form', { onSubmit: handleSubmit },
                    React.createElement('div', { className: "p-6" },
                            ...
                            React.createElement('div', { className: "bg-primary-50 dark:bg-gray-900/50 p-4 rounded-lg" },
                                ...
                                React.createElement('div', { className: "flex gap-2" },
                                    React.createElement('textarea', { 
                                        ...
                                        rows: 2,
                                        placeholder: "e.g., 'Invoice INV-123 from Supplier C for PO-45, due tomorrow...'",
                            ...
                            React.createElement('div', null,
                                ...
                                React.createElement('div', { className: "flex gap-4 p-2 bg-gray-100 dark:bg-gray-700/50 rounded-lg" },
                                    React.createElement('label', { className: "flex flex-1 items-center justify-center cursor-pointer" },
                                        ...
                                        React.createElement('span', { className: `w-full text-center px-4 py-1.5 rounded-md text-sm font-medium transition-colors ${formData.flowDirection === FlowDirection.INBOUND ? 'bg-white dark:bg-gray-800 shadow text-primary-600 dark:text-primary-300' : 'text-gray-600 dark:text-gray-400'}` }, "Procurement")
                                    ),
                                    React.createElement('label', { className: "flex flex-1 items-center justify-center cursor-pointer" },
                        ...
                        React.createElement('div', { className: "grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 mt-4" },
                            ...
                            React.createElement('div', null,
                                React.createElement('label', { htmlFor: "relatedPO", className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2" }, "Related PO #"),
