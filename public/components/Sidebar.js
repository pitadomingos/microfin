...
const AppLogo = ({ logoUrl }) => (
    React.createElement('div', { className: "flex items-center gap-3 p-4 border-b border-gray-200/10" },
        logoUrl ? (
...
export const Sidebar = ({ user, currentPage, setCurrentPage, logoUrl }) => {

    const navItems = [
        { id: 'dashboard', icon: 'grip-vertical', label: 'Dashboard' },
        { id: 'documents', icon: 'files', label: 'Documents' },
        { id: 'analytics', icon: 'magnifying-glass-chart', label: 'Analytics' },
